...
@section('container')
    ...
    <div class="flex-none flex flex-col justify-center md:justify-start px-0 lg:px-2 w-screen lg:w-[calc(100vw-350px)]">
        ...
        <div class="mt-10 pl-6 pr-6 md:pl-20 md:pr-20 font-poppins flex justify-center py-5 max-h-[75vh] overflow-y-scroll custom-scrollbar"
            ...
            <div class="h-[70vh] w-[50vh] bg-white drop-shadow-md rounded-lg px-8 py-12 flex flex-col items-center justify-between ">
                ...
                <form action="" class="flex-grow w-full space-y-6">
                    ...
                    <div class="flex flex-col gap-1">
                        <label htmlFor='confirm_password'class="text-xs md:text-sm font-light italic px-3">Confirm Password</label>
                        <div
                            class="h-10 border border-gray-400 rounded-3xl w-full flex flex-row justify-between items-center">
                            <input
                                class="h-full w-full text-xs md:text-sm bg-gray-100 rounded-3xl px-3 focus:outline-none focus:ring-0" 
