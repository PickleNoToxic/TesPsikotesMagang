...
<html>
    <head>
        ...
        <title>Intelligence Quotient & Personality Test</title>
    ...
    <body class="hidden lg:block">
        <header class="w-full pt-20 flex flex-col gap-7 justify-center items-center font-poppins text-gray-800 relative">
            ...
            <div id="counter" class="absolute right-10 top-7  rounded-lg  bg-white shadow-xl border border-gray-300 flex justify-center items-center px-4 py-2 text-gray-900 text-xl font-bold"> 
            </div>
        </header>
