        ...
        <section class="quiz-start flex flex-col justify-center items-center h-fit w-1/2 gap-5 mb-5">
            <div class="flex flex-col w-full p-3">
                <div class="flex flex-col bg-white rounded-xl drop-shadow-xl">
                    <div
                        class="font-semibold text-2xl bg-gradient-to-tr from-[#007A43] to-[#08C644] text-white text-center rounded-t-xl p-5">
                        Congratulation, You've Finished the Test
                    </div>
                    <div class="px-2 py-5 mt-3 ml-3 font-poppins text-lg text-center font-bold text-xl flex flex-col ">
                        Your Score
                    </div>
                    ...
                    <div class="flex space-x-4 justify-center   ">
                        ...
                        <div
                            class="flex flex-col space-y-4 rounded-md w-1/5 text-center items-center bg-gradient-to-t from-indigo-700 to-violet-500  p-4 shadow-lg">
                            <p class="text-[0.6rem] text-violet-300 font-bold">Intelligent Quotient</p>
                            <div
                                ...
                                <p class="text-3xl text-white">90</p>
                                <p class="text-violet-300 text-[0.5rem]">of 100</p>
                            </div>
                            <p class="mt-2 font-semibold text-xl text-white">Great</p>
                            <p class="text-xs text-violet-300 mt-1">You scored 65% higher than the people who have taken the
                                test</p>
                        </div>
                        ...
                        <div
                            class="flex flex-col space-y-4 rounded-md w-1/5 text-center items-center bg-gradient-to-t from-indigo-700 to-violet-500  p-4 shadow-lg">
                            <p class="text-[0.6rem] text-violet-300 font-bold">Personality</p>
                            <div
                                class="flex flex-col items-center rounded-full bg-gradient-to-t from-indigo-800 to-violet-600 w-20 h-20 flex items-center justify-center font-bold shadow-inner">
                            ...
                            <p class="text-xs text-violet-300 mt-1">You are an ISTJ with a strong sense of responsibility
                            </p>
                        </div>

                        <div class="flex flex-col space-y-4 w-1/5 py-4">
